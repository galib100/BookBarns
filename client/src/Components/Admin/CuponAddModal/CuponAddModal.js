...
import styles from "./CuponAddModal.module.css";
import {
  addCuponModalToggleAction,
  addCupon,
} from "../../../Actions/Admin/CuponActions";

const CuponAddModal = ({ addCuponModalToggleAction, open, addCupon }) => {
  const handleClose = () => {
    addCuponModalToggleAction();
  };
...
const mapStateToProps = (state) => ({
  open: state.auth_cupon.cupon_add_modal,
});
