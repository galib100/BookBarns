...
const BestSellerList = ({ bestSellerModalToggleAction }) => {
          ...
          <Card className={`${styles.crd} h-100 `}>
            ...
            <Card.Footer className={`${styles.operations} mt-auto`}>
              <div
                ...
                onClick={() => bestSellerModalToggleAction(item.id)}
              >
...
export default connect(null, { bestSellerModalToggleAction })(BestSellerList);
