...
const TrendingList = ({ trendingModalToggleAction }) => {
          ...
          <Card className={`${styles.crd} h-100 `}>
            ...
            <Card.Footer className={`${styles.operations} mt-auto`}>
              <div
                ...
                onClick={() => trendingModalToggleAction(item.id)}
              >
...
export default connect(null, { trendingModalToggleAction })(TrendingList);
